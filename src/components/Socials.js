...
function Socials() {
  return (
    <ul className="socials">
      <li><a id="contact" href="mailto:nerdames@gmail.com"><box-icon name='envelope'></box-icon></a></li>
        <li><a href="https://www.linkedin.com/in/jamesorji" target="_blank"><box-icon name='linkedin' type='logo' ></box-icon></a></li>
